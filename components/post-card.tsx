  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-slate-300">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-[17px] font-semibold tracking-[-0.01em] text-navy">{post.author.name}</p>
      ...
      <div className="mt-4 space-y-3">
        ...
        <Badge className="border-slate-200 bg-slate-100 text-slate-700">{post.type}</Badge>
      </div>
    </article>
  );
}
